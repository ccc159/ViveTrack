...
{
    public class ObjController1 : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            int index = temp.TrackedDevices.IndexesByClasses["Controller"][0];

            CurrenTrackedDevice = temp.TrackedDevices.AllDevices[index];
            this.Message = "Controller1";
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.ObjController1;
            }
        }
